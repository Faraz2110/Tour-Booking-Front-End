 return (
    <div className=" h-[300px] w-[300px]  bg-white rounded-2xl shadow-md hover:shadow-xl transition duration-300 p-4 w-full sm:w-[48%] md:w-[30%] lg:w-[22%] flex flex-col justify-between border border-gray-100 min-h-[420px]">
